...
all: i2c_devices.o acc_sensor.o gyro_sensor.o mpu_i2c.o

i2c_devices.o:
	$(CXX) $(CXX_FLAGS) -c $(SRC)/serial_devices/I2cDevice.cpp -o $(BIN)/i2c_devices.o

inertial_sensor.o:
	$(CXX) $(CXX_FLAGS) -c $(SRC)/inertial_sensors/InertialSensor.cpp -o $(BIN)/inertial_sensor.o

acc_sensor.o: inertial_sensor.o
	$(CXX) $(CXX_FLAGS) -c $(SRC)/inertial_sensors/AccSensor.cpp -o $(BIN)/acc_sensor.o

gyro_sensor.o: inertial_sensor.o
	$(CXX) $(CXX_FLAGS) -c $(SRC)/inertial_sensors/GyroSensor.cpp -o $(BIN)/gyro_sensor.o
...
acc_i2c_test: acc_i2c_test.o all
