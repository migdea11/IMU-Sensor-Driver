    ...
    I2cDevice(bus, addr), acc_range(range), acc_filter(filter)
{
    acc_sensor = new AccSensor(*this,
            Mpu9250Registers::ACCEL_XOUT_L, Mpu9250Registers::ACCEL_XOUT_H,
            Mpu9250Registers::ACCEL_YOUT_L, Mpu9250Registers::ACCEL_YOUT_H,
            Mpu9250Registers::ACCEL_ZOUT_L, Mpu9250Registers::ACCEL_ZOUT_H,
            Mpu9250Config::AccConfig::getAccRange(acc_range, true), Mpu9250Config::AccConfig::getAccRange(acc_range, false)); // TODO update min and max values
}
